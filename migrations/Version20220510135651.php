 ...
 */
final class Version20220510135651 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE header ADD content LONGTEXT NOT NULL');
    }
